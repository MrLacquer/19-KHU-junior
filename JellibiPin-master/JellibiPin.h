...
public:
    ...
    static const int WHEEL_PWM_RIGHT    = 11;
    static const int WHEEL_DIR_RIGHT    = 4;  // HIGH : backward, LOW : forward 

    static const int WHEEL_PWM_LEFT     = 10;
    static const int WHEEL_DIR_LEFT     = 2;  // HIGH : forward , LOW : backward
